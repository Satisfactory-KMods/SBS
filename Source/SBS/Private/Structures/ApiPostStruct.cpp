...
void FDynamicApiPostStruct::OnRequestDone( FHttpRequestPtr Request, FHttpResponsePtr Response, USBSApiSubsystem* Subsystem, TSharedPtr< FJsonObject > JsonObject ) {}
...
void FGetTagsStruct::OnRequestDone( FHttpRequestPtr Request, FHttpResponsePtr Response, USBSApiSubsystem* Subsystem, TSharedPtr< FJsonObject > JsonObject ) {
